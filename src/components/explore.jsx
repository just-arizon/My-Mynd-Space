...
const explore = () => {
  return (
    <div className="flex lg:flex-col flex-col container mx-auto sm:px-6 lg:px-40 lg:py-16 pt-12 px-5 lg:gap-2 lg:mb-16">
      ...
      <div className="flex w-full lg:flex-row flex-col pt-10">
        ...
        <div className="flex lg:flex-0 justify-between lg:px-8 py-10 lg:py-0">
                <div className="flex lg:flex-col flex-row  lg:gap-8 gap-2">
      ...
      <div className="flex items-center justify-end w-full justify-start lg:hidden block ">
              <Button className=" bg-transparent py-5 px-6 outline-none ">
                <span>View more</span>
                <Image src={Line} />
              </Button>
