    ...
    <nav className="bg-white shadow-md">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-5">
          ...
          <div className="hidden md:flex items-center flex-1 justify-center gap-3 whitespace-nowrap">
          ...
          <div className="flex items-center flex-1 justify-end">
            <a
              href="#cta"
              className="hidden md:inline-block bg-[#81D4FA] text-black px-3 py-2 rounded-md text-xs font-medium"
            >
              Get Started
            </a>
