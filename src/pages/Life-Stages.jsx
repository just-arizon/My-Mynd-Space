...
import Image1 from "../assets/Rectangle 1297.png";
import Image2 from "../assets/Rectangle 1296.png";
  ...
  const data = [
    {
      ...
      img: Image1,
      date: "June 5th, 2024",
      title: "The Life Stage Model: Delivering Mental Health Care",
    },
    {
      id: 2,
      img: Image2,
      date: "June 7th, 2024",
      title: "5 Stages of Recovery for Mental Health",
    },
  ];
    ...
    <motion.div {...motionSettings} className="flex flex-col gap-8 border-b-1 border-[#C9C9C9] pb-12 mb-12">
      <div className="flex justify-between items-center">
        <div className="relative">
          <h4 className="lg:text-lg md:text-medium sm:text-medium z-20">Life Stages and Mental Health</h4>
          <div className="bg-[#F2F6F9] w-16 h-16 rounded-full absolute -right-8 -top-5 -z-20"></div>
        </div>
