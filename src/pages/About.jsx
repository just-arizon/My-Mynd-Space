...
const About = () => {
  ...
  return (
    <motion.div
      {...motionSettings}
      className="flex flex-col lg:gap-12 gap-8 text-[#2D2D2D] bg-orange- container mx-auto sm:px-6 lg:px-40 lg:my-12 mb-10 px-5  text-[#2D2D2D] relative"
    >
      ...
      <section className="lg:my-16 my-10">
        <motion.h1
          {...motionSettings}
          className="font-bold lg:text-3xl md:text-2xl text-2xl  mb-5"
        >
