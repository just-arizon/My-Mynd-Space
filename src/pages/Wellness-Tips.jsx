...
import Image1 from "../assets/Rectangle 1295.png";
import Image2 from "../assets/Rectangle 1294.png";
    ...
    <motion.div {...motionSettings} className="flex flex-col gap-8 border-b-1 border-[#C9C9C9] pb-12 mb-12">
      <div className="flex justify-between items-center">
        <div className="relative">
          <h4 className="lg:text-lg md:text-medium sm:text-medium z-20">Self help & Wellness Tips</h4>
          <div className="bg-[#7B8CDB] w-16 h-16 rounded-full absolute -right-8 -top-5 -z-20"></div>
        </div>
